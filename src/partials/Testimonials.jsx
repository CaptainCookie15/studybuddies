      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-400">See what these students have to say about StudyBuddies:</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            {/* 1st testimonial */}
            <div id="shreeTestimony" className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
              <div>
              ...
              {/* 2nd testimonial */}
              <div id="tateTestimony" className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="200">
                <div>
                  <div className="relative inline-flex flex-col mb-4">
